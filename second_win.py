...
class SecondWin(QWidget):
    ...
    def unit(self):
        ...
        self.button1 = QPushButton('Начать111')
        self.button2 = QPushButton('Начать')
        self.button3 = QPushButton('Начать')
        self.button4 = QPushButton('Начать')
        ...
        self.lay.addWidget(self.button4,alignment = Qt.AlignLeft)
